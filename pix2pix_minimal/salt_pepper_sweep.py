...
SALT_PEPPER_AMOUNTS = [0.0, 0.0001, 0.0003, 0.0005, 0.0007, 0.001, 0.003, 0.005, 0.007, 0.01]
...
plt.title('Salt & Pepper Robustness Sweep (Val Set) -- SSIM / LPIPS / PSNR vs Amount', fontsize=13)
plt.tight_layout()
